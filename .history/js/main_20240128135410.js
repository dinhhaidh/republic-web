...
sr.reveal(`.home__content, .bedroom__images, .lighting__form`) //hiệu ứng trên xuống
sr.reveal(`.home__images`,{delay: 600, origin: 'bottom'})
sr.reveal(` .lounge__container`,{interval: 100}) //hiệu ứng trêm xuống lần lần từng giây
sr.reveal(`.kitchen__special`,{origin: 'right'})
sr.reveal(`.bedroom__content`,{origin: 'left'})
sr.reveal(`.kitchen__image`,{origin: 'left'})
sr.reveal(`.kitchen__kitchenwarea`,{origin: 'left'})
sr.reveal(`.lighting__list`,{origin: 'top'})
